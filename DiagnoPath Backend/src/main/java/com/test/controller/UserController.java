...
public class UserController {
	...
	@PostMapping
	public String registerUserAccount(@Valid @ModelAttribute("user") UserRegisterDto user, BindingResult result,Model model)
	{
		...
		if (result.hasErrors())
	   {
		...
		String subject="DiagnoPath : Registration Successful";
		String message=""
				+ "<div style='border:1px solid #e2e2e2; padding:20px'>"
				+ "<h2>"
				+ "Dear "+user.getName()+"</h2>"+"<br>"+"<h1>"
				+ "<b>" +" Congratulations! You have successfully registered on the DiagnoPath portal "
				+ "</n>"
				+ "</h1> "
				+ "</div>";
		String to=email;
